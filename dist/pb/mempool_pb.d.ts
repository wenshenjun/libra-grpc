...
export class AddTransactionWithValidationResponse extends jspb.Message {
  ...
  getStatus(): mempool_status_pb.MempoolAddTransactionStatusMap[keyof mempool_status_pb.MempoolAddTransactionStatusMap];
  setStatus(value: mempool_status_pb.MempoolAddTransactionStatusMap[keyof mempool_status_pb.MempoolAddTransactionStatusMap]): void;
...
export namespace AddTransactionWithValidationResponse {
  export type AsObject = {
    ...
    status: mempool_status_pb.MempoolAddTransactionStatusMap[keyof mempool_status_pb.MempoolAddTransactionStatusMap],
  }
}
