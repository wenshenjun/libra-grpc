...
export class TransactionArgument extends jspb.Message {
  getType(): TransactionArgument.ArgTypeMap[keyof TransactionArgument.ArgTypeMap];
  setType(value: TransactionArgument.ArgTypeMap[keyof TransactionArgument.ArgTypeMap]): void;
...
export namespace TransactionArgument {
  export type AsObject = {
    type: TransactionArgument.ArgTypeMap[keyof TransactionArgument.ArgTypeMap],
  ...
  export const ArgType: ArgTypeMap;
}
...
export class WriteOp extends jspb.Message {
  ...
  getType(): WriteOpTypeMap[keyof WriteOpTypeMap];
  setType(value: WriteOpTypeMap[keyof WriteOpTypeMap]): void;
...
export namespace WriteOp {
  export type AsObject = {
    ...
    type: WriteOpTypeMap[keyof WriteOpTypeMap],
  }
}
...
export interface WriteOpTypeMap {
  WRITE: 0;
  DELETE: 1;
}

export const WriteOpType: WriteOpTypeMap;
