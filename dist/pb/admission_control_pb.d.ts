...
export class SubmitTransactionResponse extends jspb.Message {
  ...
  hasAcStatus(): boolean;
  clearAcStatus(): void;
  getAcStatus(): AdmissionControlStatusMap[keyof AdmissionControlStatusMap];
  setAcStatus(value: AdmissionControlStatusMap[keyof AdmissionControlStatusMap]): void;

  hasMempoolStatus(): boolean;
  clearMempoolStatus(): void;
  getMempoolStatus(): mempool_status_pb.MempoolAddTransactionStatusMap[keyof mempool_status_pb.MempoolAddTransactionStatusMap];
  setMempoolStatus(value: mempool_status_pb.MempoolAddTransactionStatusMap[keyof mempool_status_pb.MempoolAddTransactionStatusMap]): void;
...
export namespace SubmitTransactionResponse {
  export type AsObject = {
    ...
    acStatus: AdmissionControlStatusMap[keyof AdmissionControlStatusMap],
    mempoolStatus: mempool_status_pb.MempoolAddTransactionStatusMap[keyof mempool_status_pb.MempoolAddTransactionStatusMap],
...
export interface AdmissionControlStatusMap {
  ACCEPTED: 0;
  BLACKLISTED: 1;
  REJECTED: 2;
}

export const AdmissionControlStatus: AdmissionControlStatusMap;
